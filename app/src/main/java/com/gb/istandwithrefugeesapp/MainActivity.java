...
import de.hdodenhof.circleimageview.CircleImageView;
       ...
       public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
           ...
           private Bitmap onlineLogo;
           private SelectedOrgEUFragment selectedOrgEUFrag;
           private ListEuropeFragment listEuropeFragment;
           private EUListAdapter listEuropeAdapter;
           private Bitmap EULogo;
           private EUMarker EUMarkerToBeAdded;

           public Bitmap getEULogo() {
               return EULogo;
           }

           public void setEULogo(Bitmap EULogo) {
               this.EULogo = EULogo;
           }

           public EUMarker getEUMarkerToBeAdded() {
               return EUMarkerToBeAdded;
           }

           public void setEUMarkerToBeAdded(EUMarker EUMarkerToBeAdded) {
               this.EUMarkerToBeAdded = EUMarkerToBeAdded;
           }
           ...
           public OnlineAid getOnlineAidToBeAdded() {
               return onlineAidToBeAdded;
           }

           public Bitmap getOnlineLogo() {
               return onlineLogo;
           }

           public void setOnlineLogo(Bitmap onlineLogo) {
               this.onlineLogo = onlineLogo;
           }

           public void setOnlineAidToBeAdded(OnlineAid onlineAidToBeAdded) {
               this.onlineAidToBeAdded = onlineAidToBeAdded;
           }
           ...
           private com.gb.istandwithrefugeesapp.CustomDialogEUMap CustomDialogEUMap;
           private ArrayList<String> selectedCountries = new ArrayList<>();

           public com.gb.istandwithrefugeesapp.CustomDialogEUMap getCustomDialogEUMap() {
               return CustomDialogEUMap;
           }

           public void setCustomDialogEUMap(com.gb.istandwithrefugeesapp.CustomDialogEUMap customDialogEUMap) {
               CustomDialogEUMap = customDialogEUMap;
           }
           ...
           private OnlineAid onlineAidToBeAdded;
           ...
           private SparseArray<EUMarker> overseasMap;
           private SparseArray<OnlineAid> onlineMap;
           ...
           protected void onCreate(Bundle savedInstanceState) {
               ...
               dbHelper.setOverseasMarkersMap(((MyAppApplication) this.getApplication()).getOverseasMarkersMap());
               dbHelper.setLogoUrlsOverseas(((MyAppApplication) this.getApplication()).getLogoUrlsOverseas());
               dbHelper.setLongLatMapEU(((MyAppApplication) this.getApplication()).getLongLatMapEU());
               dbHelper.setOnlineAids(((MyAppApplication) this.getApplication()).getOnlineAids());
               dbHelper.setLogoUrlsOnline(((MyAppApplication) this.getApplication()).getLogoUrlsOnline());
               dbHelper.setCountryAndRegionsArray(((MyAppApplication) this.getApplication()).getCountryAndRegionsArray());
               ...
               ((MyAppApplication) this.getApplication()).setLongLatMapEU(null);
               ((MyAppApplication) this.getApplication()).setOverseasMarkersMap(null);
               ((MyAppApplication) this.getApplication()).setLogoUrlsOverseas(null);
               ((MyAppApplication) this.getApplication()).setOnlineAids(null);
               ((MyAppApplication) this.getApplication()).setLogoUrlsOnline(null);
               ((MyAppApplication) this.getApplication()).setCountryAndRegionsArray(null);
               ...
               AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                   ...
                   public void onSuccess(final Account account) {
                       ...
                       if (dbHelper.getMarkersMap().size() == 0 || dbHelper.getOnlineAids().size() == 0 || dbHelper.getOverseasMarkersMap().size() == 0) {
           ...
           private void getOnlineContributions() {
               for (int i = 0; i < onlineMap.size(); i++) {
                   OnlineAid onlineAid = onlineMap.get(i + 1);
                   if (onlineAid.getLoginId() == Integer.parseInt(anActivity.getDbHelper().getLoginId())) {
                       TreeMap<Enum, Object> onlineMarkerMap = new TreeMap();
                       onlineMarkerMap.put(BookmarkType.ONLINE, onlineAid);
                       contributionsMap.put(contributionsPosition, onlineMarkerMap);
                       contributionsPosition++;
                   }
               }
           }
                       ...
                       if (TransferState.COMPLETED == state) {
                           ...
                           switch (downloadResultType) {
                               ...
                               case 2:
                                   ...
                                   break;
                               case 3:
                                   onlineListAdapter.downloadResult();
                                   break;
                               case 4:
                                   selectedOrgEUFrag.downloadResult();
                                   break;
                               case 5:
                                   listEuropeAdapter.downloadResult();
                                   break;
                           }
                       }
                   }
           ...
           public void checkDownloadPermissionsBookmarksOnline(int i, OnlineListAdapter onlineListAdapter) {
               this.onlineListAdapter = onlineListAdapter;
               checkDownloadPermissions(3);
           }

           private void checkDownloadPermissionsSelected(int i, MainActivity.SelectedOrgEUFragment selectedOrgEUFragment) {
               this.selectedOrgEUFrag = selectedOrgEUFragment;
               checkDownloadPermissions(4);
           }
           public void checkDownloadPermissionsSelected(int i, EUListAdapter listEuropeAdapter) {
               this.listEuropeAdapter = listEuropeAdapter;
               checkDownloadPermissions(5);
           }
           ...
           private void uploadData(final BookmarkType bookmarkType) {
               AWSMobileClient.getInstance().initialize(this, new AWSStartupHandler() {
                   @Override
                   public void onComplete(AWSStartupResult awsStartupResult) {
                       switch (bookmarkType) {
           ...
           private void uploadOnlineLogo() {
               ...
               Bitmap bitmap = Bitmap.createScaledBitmap(anActivity.onlineLogo, 150, 150, true);
               ...
               final String key = "public/online/" + onlineAidToBeAdded.getMarkerId() + ".png";
               final String logo = "https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/" + key;
               onlineAidToBeAdded.setLogoUrl(logo);
               TransferObserver uploadObserver =
                       transferUtility.upload(
                               key,
                               finalFile,
               ...
               uploadObserver.setTransferListener(new TransferListener() {
                   ...
                   public void onStateChanged(int id, TransferState state) {
                       if (TransferState.COMPLETED == state) {
                           ...
                           Glide.with(anActivity)
                                   .load(logo).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
                                   .signature(new ObjectKey(onlineAidToBeAdded.getLastModified())))
                                   .preload(dimen, dimen);
                           progressDialog.dismiss();
                           HomeFragment frag = new HomeFragment();
                           loadFragment(frag);
           ...
           private void uploadEULogo() {
               ...
               Bitmap bitmap = Bitmap.createScaledBitmap(anActivity.EULogo, 150, 150, true);
               ...
               final String key = "public/EU/" + EUMarkerToBeAdded.getMarkerId() + ".png";
               final String logo = "https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/" + key;
               EUMarkerToBeAdded.setImageUrl(logo);
               TransferObserver uploadObserver =
                       transferUtility.upload(
                               key,
                               finalFile,
               ...
               uploadObserver.setTransferListener(new TransferListener() {
                   ...
                   public void onStateChanged(int id, TransferState state) {
                       if (TransferState.COMPLETED == state) {
                           ...
                           Glide.with(anActivity)
                                   .load(logo).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
                                   .signature(new ObjectKey(EUMarkerToBeAdded.getLastModified())))
                                   .preload(dimen, dimen);
                           progressDialog.dismiss();
                           HomeFragment frag = new HomeFragment();
                           loadFragment(frag);
           ...
           public void addLogo(BookmarkType bookmarkType) {
               uploadData(bookmarkType);
           }
           ...
           private void ListItemClicked(int position) {
               ...
               switch (position) {
                   ...
                   case 4:
                       ...
                       break;
                   case 6:
                       fragment = new ListEuropeFragment();
                       break;
                   case 7:
                       fragment = new AddTitleEUFragment();
                       anActivity.EULogo = null;
                       anActivity.EUMarkerToBeAdded = new EUMarker("", "", "http://www.", "",
                               "", "", "", 0, Integer.parseInt(anActivity.getDbHelper().getLoginId()), "", "");
                       break;
                   case 8:
                   ...
                   case 9:
                       ...
                       break;
                   case 10:
                       fragment = new AddTitleOnlineFragment();
                       anActivity.onlineLogo = null;
                       anActivity.onlineAidToBeAdded = new OnlineAid("", "", "http://www.", "",
                               "", 0, Integer.parseInt(anActivity.getDbHelper().getLoginId()));
                       break;
                   case 12:
           ...
           public static class OverseasFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   anActivity = (MainActivity) getActivity();
                   assert anActivity != null;
                   anActivity.getmTitle().setText("Volunteer in Europe");
                   anActivity.getSupportActionBar().show();
                   ...
                   overseasimg_1.setOnClickListener(this);
                   overseasimg_3.setOnClickListener(this);
                   overseasimg_2.setOnClickListener(this);
               ...
               public void onClick(View v) {
                   ...
                   if (v == overseasimg_1) {
                       Fragment fragment = new EUMapFragment();
                   ...
                   if (v == overseasimg_3) {
                       Fragment fragment = new ListEuropeFragment();
                       anActivity.getSupportFragmentManager().beginTransaction()
                               .replace(R.id.content_frame, fragment)
                               .addToBackStack(null)
                               .commit();
                   ...
                   if (v == overseasimg_2) {
                       anActivity.EULogo = null;
                       Fragment fragment = new AddTitleEUFragment();
                       anActivity.EUMarkerToBeAdded = new EUMarker("", "", "http://www.", "",
                               "", "", "", 0, Integer.parseInt(anActivity.getDbHelper().getLoginId()), "", "");
           ...
           public static class OnlineFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   onlineimg_1.setOnClickListener(this);
                   onlineimg_2.setOnClickListener(this);
               ...
               @Override
               public void onClick(View v) {
                   if (v.getId() == R.id.onlineimg1) {
                       Fragment fragment = new ListOnlineFragment();
                       anActivity.loadFragment(fragment);
                   }
                   if (v.getId() == R.id.onlineimg2) {
                       anActivity.onlineLogo = null;
                       anActivity.onlineAidToBeAdded = new OnlineAid("", "", "http://www.", "",
                               "", 0, Integer.parseInt(anActivity.getDbHelper().getLoginId()));
                       Fragment fragment = new AddTitleOnlineFragment();
                       anActivity.loadFragment(fragment);
                   }
               }
           ...
           public static class AddTitleEUFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   titleBox = view.findViewById(R.id.title_box);
                   titleBox.setText(anActivity.getEUMarkerToBeAdded().getTitle());
               ...
               public void onClick(View v) {
                   if (checkTitle(titleBox.getText().toString())) {
                       Fragment frag = new AddLogoEUFragment();
                       String title = titleBox.getText().toString().trim();
                       anActivity.getEUMarkerToBeAdded().setTitle(title);
                       anActivity.loadFragment(frag);
                   }
               }
...
// TODO Auto-generated method stub
           ...
           public static class AddDescriptionEUFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   desBox = view.findViewById(R.id.title_box);
                   desBox.setText(anActivity.EUMarkerToBeAdded.getDescription());
                   desBox.addTextChangedListener(new TextWatcher() {
                       @Override
                       public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                       }
               ...
               public void onClick(View v) {
                   ...
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkDescription(desBox.getText().toString())) {
                               frag = new AddTypeOfAidEUFragment();
                               String desc = desBox.getText().toString().trim();
                               anActivity.EUMarkerToBeAdded.setDescription(desc);
                               anActivity.loadFragment(frag);
                           }
                           break;
                   }
           ...
           public static class AddTitleOnlineFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   titleBox = view.findViewById(R.id.title_box);
                   titleBox.setText(anActivity.onlineAidToBeAdded.getTitle());
                   nextButton = view.findViewById(R.id.next_button);
                   nextButton.setOnClickListener(this);
               ...
               public void onClick(View v) {
                   if (checkTitle(titleBox.getText().toString())) {
                       Fragment frag = new AddLogoOnlineFragment();
                       String title = titleBox.getText().toString().trim();
                       anActivity.onlineAidToBeAdded.setTitle(title);
                       anActivity.loadFragment(frag);
                   }
               }
           ...
           public static class AddDescriptionOnlineFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   desBox = view.findViewById(R.id.title_box);
                   desBox.setText(anActivity.onlineAidToBeAdded.getDescription());
                   desBox.addTextChangedListener(new TextWatcher() {
                       @Override
                       public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                       }
               ...
               public void onClick(View v) {
                   ...
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkDescription(desBox.getText().toString())) {
                               frag = new AddWebsiteOnlineFragment();
                               String desc = desBox.getText().toString().trim();
                               anActivity.onlineAidToBeAdded.setDescription(desc);
                               anActivity.loadFragment(frag);
                           }
                           break;
                   }
...
// TODO Auto-generated method stub
                       ...
                       case R.id.drop:
                           ...
                           typeOfAidAdapter = new ArrayAdapter<>(anActivity, R.layout.simple_list_item_2, types);
                           typeOfAidAdapter.setDropDownViewResource(R.layout.simple_list_item_1);
                           listView.setAdapter(typeOfAidAdapter);
                           listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
...
// TODO Auto-generated method stub
           ...
           public static class AddTypeOfAidEUFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   nextButton.setOnClickListener(this);
                   typeOfAidTextView = view.findViewById(R.id.ref_name);
                   if (anActivity.EUMarkerToBeAdded.getTypeOfAid() != null) {
                       typeOfAid = anActivity.EUMarkerToBeAdded.getTypeOfAid();
                       typeOfAidTextView.setText(typeOfAid);
                   }
                   typeOfAidTextView.setOnClickListener(this);
                   dropArrow.setOnClickListener(this);
               ...
               public void onClick(View v) {
                   ...
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkTypeOfAid(typeOfAid)) {
                               frag = new AddWebsiteEUFragment();
                               anActivity.EUMarkerToBeAdded.setTypeOfAid(typeOfAid);
                               anActivity.loadFragment(frag);
                           }
                           break;
                       case R.id.ref_name:
...
// TODO Auto-generated method stub
           ...
           public static class AddWebsiteEUFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   webBox = view.findViewById(R.id.title_box);
                   webBox.setText(anActivity.EUMarkerToBeAdded.getWebsite());
               ...
               public void onClick(View v) {
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkWebsite(webBox.getText().toString())) {
                               Fragment frag = new AddAddressEUFragment();
                               anActivity.EUMarkerToBeAdded.setWebsite(webBox.getText().toString());
           ...
           public static class AddWebsiteOnlineFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   webBox = view.findViewById(R.id.title_box);
                   webBox.setText(anActivity.onlineAidToBeAdded.getWebsite());
               ...
               public void onClick(View v) {
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkWebsite(webBox.getText().toString())) {
                               Fragment frag = new AddAddressFragment();
                               anActivity.onlineAidToBeAdded.setWebsite(webBox.getText().toString());
                               anActivity.setProgressDialog(new ProgressDialog(anActivity));
                               anActivity.getProgressDialog().setMessage("Adding Online Aid");
                               anActivity.getProgressDialog().show();
                               anActivity.getDbHelper().addOnlineAid();
                           }
                           break;
                   }
               }
...
// TODO Auto-generated method stub
           ...
           public static class AddLogoEUFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   if (anActivity.EULogo == null && anActivity.EUMarkerToBeAdded.getImageUrl().length() > 2) {
                       Glide.with(this).load(anActivity.EUMarkerToBeAdded.getImageUrl()).apply(new RequestOptions()
                               .signature(new ObjectKey(anActivity.EUMarkerToBeAdded.getLastModified()))
                   ...
                   if (anActivity.EULogo != null) {
                       ByteArrayOutputStream stream = new ByteArrayOutputStream();
                       anActivity.EULogo.compress(Bitmap.CompressFormat.PNG, 100, stream);
                       Glide.with(this)
                               .asBitmap()
               ...
               public void onClick(View v) {
                   ...
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkLogo()) {
                               frag = new AddDescriptionEUFragment();
                               anActivity.loadFragment(frag);
                           }
                           break;
                       case R.id.logo_holder:
                           ImagePicker.pickImageGalleryOnly(AddLogoEUFragment.this, GALLERY_ONLY_REQ);
                           break;
                   }
               }
           ...
           public static class AddAddressEUFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   View view = inflater.inflate(R.layout.add_eu_address, viewGroup, false);
                   anActivity = (MainActivity) getActivity();
                   assert anActivity != null;
                   anActivity.getmTitle().setText("Add Address");
                   cityTitle = view.findViewById(R.id.city_title);
                   ...
                   country = anActivity.EUMarkerToBeAdded.getCountry();
                   regionText = view.findViewById(R.id.region_container);
                   regionText.setOnClickListener(this);
                   TextView regionTextView = (TextView) view.findViewById(R.id.ref_name);
                   regionTextView.setText(country);
                   //sets font for icon text
                   Typeface titleFont = Typeface.
                           createFromAsset(getContext().getAssets(), "fonts/Lobster_1.3.otf");
                   cityTitle.setTypeface(titleFont);
                   cityEdit = view.findViewById(R.id.city_text);
                   cityEdit.setText(anActivity.EUMarkerToBeAdded.getCityOrTown());
                   nextButton = view.findViewById(R.id.next_button);
                   previousButton = view.findViewById(R.id.back_button);
                   previousButton.setOnClickListener(this);
                   nextButton.setOnClickListener(this);
               ...
               public void onClick(View v) {
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkInputs()) {
                               anActivity.EUMarkerToBeAdded.setCityOrTown(cityEdit.getText().toString());
                               anActivity.EUMarkerToBeAdded.setCountry(country);
                               anActivity.EUMarkerToBeAdded.setLastModified(String.valueOf(System.currentTimeMillis()));
                               anActivity.setProgressDialog(new ProgressDialog(anActivity));
                               anActivity.getProgressDialog().setMessage("Adding Address");
                               anActivity.getProgressDialog().show();
                               anActivity.getDbHelper().addAddressOrgEU();
                           }
                           break;
                       case R.id.region_container:
                           final CustomDialogNoSearch cdd = new CustomDialogNoSearch(getActivity());
                           ...
                           ListView listView = view.findViewById(R.id.dialog_listview);
                           Set<String> treeSet = anActivity.dbHelper.getCountryAndRegionsArray().keySet();
                           ArrayList<String> list1 = new ArrayList<>(treeSet);
                           regionAdapter = new ArrayAdapter<>(anActivity, R.layout.simple_list_item_2, list1);
                           regionAdapter.setDropDownViewResource(R.layout.simple_list_item_1);
                           listView.setAdapter(regionAdapter);
                           listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
...
// TODO Auto-generated method stub
               ...
               boolean checkInputs() {
                   ...
                   if (!checkCountry(country.toString())) {
                       checksSucceed = false;
                       return checksSucceed;
           ...
           public static class AddLogoOnlineFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   logoHolder = view.findViewById(R.id.logo_holder);
                   int dimen = (int) getResources().getDimensionPixelSize(R.dimen._150sdp);
                   if (anActivity.onlineLogo == null && anActivity.onlineAidToBeAdded.getLogoUrl().length() > 2) {
                       Glide.with(this).load(anActivity.onlineAidToBeAdded.getLogoUrl()).apply(new RequestOptions()
                               .signature(new ObjectKey(anActivity.onlineAidToBeAdded.getLastModified()))
                               .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)).listener(new RequestListener<Drawable>() {
                           @Override
                           public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                               return false;
                           ...
                           public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                               BitmapDrawable b = (BitmapDrawable) resource;
                               anActivity.onlineLogo = b.getBitmap();
                               return false;
                           }
                       })
                               .apply(new RequestOptions().override(dimen,
                   ...
                   if (anActivity.onlineLogo != null) {
                       ByteArrayOutputStream stream = new ByteArrayOutputStream();
                       anActivity.onlineLogo.compress(Bitmap.CompressFormat.PNG, 100, stream);
                       Glide.with(this)
                               .asBitmap()
                               .load(stream.toByteArray())
                               .apply(new RequestOptions().override(dimen,
               ...
               public void onClick(View v) {
                   ...
                   switch (v.getId()) {
                       ...
                       case R.id.next_button:
                           if (checkLogo()) {
                               frag = new AddDescriptionOnlineFragment();
                               anActivity.loadFragment(frag);
                           }
                           break;
                       case R.id.logo_holder:
                           ImagePicker.pickImageGalleryOnly(AddLogoOnlineFragment.this, GALLERY_ONLY_REQ);
                           break;
                   }
               }
           ...
           public static class ListEuropeFragment extends android.support.v4.app.Fragment implements View.OnClickListener {

               private EUListAdapter adapter;
               private RecyclerView.LayoutManager layoutManager;
               private RecyclerView recyclerView;
               private TextView areaTextView;
               private TextView typeOfAidTextView;
               ...
               public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   //inflates xml layout. sets toolbar title to 'Home'
                   View view = inflater.inflate(R.layout.list_europe_fragment, viewGroup, false);
                   anActivity = (MainActivity) getActivity();
                   assert anActivity != null;
                   anActivity.getmTitle().setText("List Voluntary Orgs");
                   recyclerView = view.findViewById(R.id.list_markers_recycler_view);
                   anActivity.getSupportActionBar().show();
                   dropArrow = view.findViewById(R.id.drop);
                   Glide.with(this)
                   ...
                   recyclerView.setLayoutManager(layoutManager);
                   recyclerView.setItemAnimator(new DefaultItemAnimator());
                   SparseArray<EUMarker> euList = anActivity.getDbHelper().getOverseasMarkersMap();
                   SparseArray<LatLong> longLatMap = anActivity.getDbHelper().getLongLatMapEU();
                   adapter = new EUListAdapter(anActivity, euList, longLatMap, this);
                   recyclerView.setHasFixedSize(false);
                   recyclerView.setAdapter(adapter);
                   adapter.notifyDataSetChanged();
                   TextView results = view.findViewById(R.id.results);
                   ...
                   Set<String> treeSet = anActivity.dbHelper.getCountryAndRegionsArray().keySet();
                   ArrayList<String> list1 = new ArrayList<>(treeSet);
                   anActivity.setSelectedCountries(list1);
                   anActivity.setSearchString("");
                   ...
                   int index = 0;
                   for (String title: expandableListTitle) {
                       ArrayList arrayList = expandableListChildren.get(title);
                       ArrayList <Boolean> arrayList1 = new ArrayList<>();
                       int size = arrayList.size();
                       for (int i = 0; i < size; i++) {
                           arrayList1.add(true);
                       }
                       regionsSelected.put(index, arrayList1);
                       index++;
                   }
                   SearchView searchView = view.findViewById(R.id.search_list);
                   searchView.setIconifiedByDefault(false);
               ...
               public void onClick(View v) {
                   ...
                   if (v == areaTextView || v == dropArrow) {
                           ...
                           cdd.show();
                           cdd.setCancelable(false);
                           Window vi = cdd.getWindow();
                           ExpandableListView expandableListView = vi.findViewById(R.id.dialog_listview);
                           ...
                           Button button = vi.findViewById(R.id.next_button);
                           button.setOnClickListener(new View.OnClickListener() {
                               @Override
                               public void onClick(View view) {
                                   ...
                                   if (anActivity.getSelectedCountries().size() > 1) {
                                       ...
                                       areaTextView.setText(anActivity.getSelectedCountries().get(0));
                                       cdd.dismiss();
                                       getAllFilter();
                                   }
                               }
           ...
           public static class ListOnlineFragment extends android.support.v4.app.Fragment {
               ...
               public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   recyclerView.setLayoutManager(layoutManager);
                   recyclerView.setItemAnimator(new DefaultItemAnimator());
                   SparseArray<OnlineAid> onlineAids = anActivity.getDbHelper().getOnlineAids();
                   adapter = new OnlineListAdapter(anActivity, onlineAids, this);
                   recyclerView.setHasFixedSize(false);
                   recyclerView.setAdapter(adapter);
                   adapter.notifyDataSetChanged();
                   TextView results = view.findViewById(R.id.results);
           ...
           public static class BookmarksFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   recyclerView.setLayoutManager(layoutManager);
                   recyclerView.setItemAnimator(new DefaultItemAnimator());
                   ArrayList<Bookmark> bookmarksArray = anActivity.getDbHelper().getBookmarksArray();
                   SparseArray<LatLong> longLatMap = anActivity.getDbHelper().getLongLatMap();
                   adapter = new BookmarksListAdapter(anActivity, bookmarksArray, this);
                   recyclerView.setHasFixedSize(false);
                   recyclerView.setAdapter(adapter);
                   adapter.notifyDataSetChanged();
                   TextView results = view.findViewById(R.id.results);
...
// TODO Auto-generated method stub
           ...
           public static class ManageContributionsFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   anActivity = (MainActivity) getActivity();
                   assert anActivity != null;
                   anActivity.getmTitle().setText("My Contributions");
                   anActivity.ukMap = anActivity.getDbHelper().getMarkersMap();
                   anActivity.overseasMap = anActivity.getDbHelper().getOverseasMarkersMap();
                   anActivity.onlineMap = anActivity.getDbHelper().getOnlineAids();
...
// TODO Auto-generated method stub
           ...
           public static class OtherResourcesFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               ...
               public void onClick(View v) {
                   if (v == button) {
                       Uri uri = Uri.parse("https://refaid.com");
           ...
           public static class UkMapFragment extends android.support.v4.app.Fragment implements View.OnClickListener, com.androidmapsextensions.OnMapReadyCallback, GoogleMap.OnMyLocationClickListener, com.androidmapsextensions.GoogleMap.OnMyLocationButtonClickListener {
               ...
               public void onMapReady(final com.androidmapsextensions.GoogleMap map) {
                   ...
                   for (int i = 1; i <= latLongMap.size(); i++) {
                       ...
                       final com.androidmapsextensions.Marker marker = map.addMarker(mo);
           ...
           public static class EUMapFragment extends android.support.v4.app.Fragment implements View.OnClickListener, com.androidmapsextensions.OnMapReadyCallback, GoogleMap.OnMyLocationClickListener, com.androidmapsextensions.GoogleMap.OnMyLocationButtonClickListener {
               private static final String TAG = "";
               private static final String REQUEST_LOCATION = "Allow the Map to access your current Location";
               private View rootView;
               private com.androidmapsextensions.GoogleMap googleMap;
               ...
               public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
                   ...
                   anActivity = (MainActivity) getActivity();
                   latLongMap = anActivity.getDbHelper().getLongLatMapEU();
               ...
               public void onClick(View v) {
                   if (v == button) {
                       anActivity.setCustomDialogEUMap(new CustomDialogEUMap(getActivity(), this));
                       anActivity.getCustomDialogEUMap().getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                       anActivity.getCustomDialogEUMap().show();
                       anActivity.getCustomDialogEUMap().setCancelable(false);
                   }
               }
               ...
               public void onMapReady(final com.androidmapsextensions.GoogleMap map) {
                   ...
                   oms = new OverlappingMarkerSpiderfier(googleMap);
                   checkMapPermissions();
                   LatLng startingZoom = new LatLng(50, 13.2551);
                   float zoomLevel = 4;
                   if (selectedLat != 0 && selectedLon != 0) {
                       startingZoom = new LatLng(selectedLat, selectedLon);
                       zoomLevel = 17;
                   ...
                   googleMap.setInfoWindowAdapter(new CustomInfoViewEUAdapter(LayoutInflater.from(anActivity), mMarkers, anActivity));
                   googleMap.setOnInfoWindowClickListener(new com.androidmapsextensions.GoogleMap.OnInfoWindowClickListener() {
                       @Override
                       public void onInfoWindowClick(com.androidmapsextensions.Marker marker) {
                           Fragment fragment = new MainActivity.SelectedOrgEUFragment();
                           String markerId = mMarkers.get(marker.getId());
                           loadFragment(fragment, markerId);
                       }
                   });
           ...
           public static class SelectedOrgFragment extends android.support.v4.app.Fragment implements s3DownloaderInterface {
               ...
               public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   dateImg = view.findViewById(R.id.date_img);
                   timeImg = view.findViewById(R.id.time_img);
                   copyImage = view.findViewById(R.id.copy_icon);
                   ...
                   Glide.with(this).load("https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/public/map_button.png")
                           .into(mapImg);
                   Glide.with(anActivity).load("https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/public/copy.png")
                           .into(copyImage);

                   final TextView textViewAddress = view.findViewById(R.id.address);
                   copyImage.setOnClickListener(new View.OnClickListener() {
                       @Override
                       public void onClick(View v) {
                           ClipboardManager clipboard = (ClipboardManager) anActivity.getSystemService(Context.CLIPBOARD_SERVICE);
                   ...
                   selectedBookmark = anActivity.findBookmark(Integer.parseInt(markerId), BookmarkType.UK);
               ...
               private void removeBookmark() {
                   ...
                   anActivity.getDbHelper().getBookmarksArray().remove(selectedBookmark);
                   Glide.with(this).load("https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/public/bookmarks_button.png")
                           .into(bookmarkImg);
                   anActivity.getDbHelper().removeBookmark(bookmarkId);
               }

               private void addBookmark(BookmarkType bookmarkType) {
                   ...
                   Glide.with(this).load("https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/public/bookmarks_button_alt.png")
                           .into(bookmarkImg);
                   anActivity.getDbHelper().addBookmark(Integer.valueOf(markerId), bookmarkType, this);
               }
           ...
           public static class SelectedOrgEUFragment extends android.support.v4.app.Fragment implements s3DownloaderInterface {

               private CircleImageView logo;
               private String title;
               private SelectedOrgEUFragment selectedOrgEUFragment;
               private MainActivity anActivity;
               private String markerId;
               private int bookmarkId;
               private EUMarker currentMarker;
               private TextView titleText;
               private TextView desc;
               private TextView address;
               private ImageView bookmarkImg;
               ...
               public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   //inflates xml layout. sets toolbar title to 'Home'
                   View view = inflater.inflate(R.layout.selected_org_eu_view, viewGroup, false);
                   selectedOrgEUFragment = this;
                   anActivity = (MainActivity) getActivity();
                   assert anActivity != null;
                   Bundle bundle = this.getArguments();
                   if (bundle != null) {
                   ...
                   Integer id = Integer.parseInt(markerId);
                   currentMarker = anActivity.getDbHelper().getOverseasMarkersMap().get(id);
                       titleText.setText(currentMarker.getTitle());
                       logoUrl = currentMarker.getImageUrl();

                       Glide.with(anActivity).load(logoUrl).apply(new RequestOptions()
                               .signature(new ObjectKey(currentMarker.getLastModified()))
                               .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC))
                               .into(logo);
                       ...
                       if (cityOrTown.length() != 0 && region.length() != 0) {
                           cityOrTown = cityOrTown + ", ";
                           region = cityOrTown + ", ";
                           address.setText(cityOrTown + region + country);
                       }
                       else{
                           address.setText(country);
                       }

                       desc.setText(currentMarker.getDescription());
                       webImg.setOnClickListener(new View.OnClickListener() {
                           @Override
                           public void onClick(View v) {
                   ...
                   selectedBookmark = anActivity.findBookmark(Integer.parseInt(markerId), BookmarkType.OVERSEAS);
                   if (selectedBookmark != null) {
                       Glide.with(this)
                               .load("https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/public/bookmarks_button_alt.png")
                               .into(bookmarkImg);
                   ...
                   mapImg.setOnClickListener(new View.OnClickListener() {
                       @Override
                       public void onClick(View v) {
                           LatLong l = anActivity.getDbHelper().getLongLatMapEU().get(Integer.parseInt(markerId));
                           float lat = l.getLat();
                           float lon = l.getLon();
                   ...
                   bookmarkImg.setOnClickListener(new View.OnClickListener() {
                       ...
                       public void onClick(View v) {
                           ...
                           anActivity.checkDownloadPermissionsSelected(4, selectedOrgEUFragment);
               ...
               public void downloadResult() {
                   ...
                   if (bookmarkId != 0) {
                       ...
                       addBookmark(BookmarkType.OVERSEAS);
                   }
               }
           ...
           Bookmark findBookmark(int selectedMarkerId, BookmarkType bookmarkType) {
               Bookmark selectedBookmark = null;
               for (int i = 0; i < getDbHelper().getBookmarksArray().size(); i++) {
                   Bookmark bookmark = (Bookmark) getDbHelper().getBookmarksArray().get(i);
                   if (bookmark.getBookmarkType() == bookmarkType && bookmark.getMarkerId() == Integer.valueOf(selectedMarkerId))
                       selectedBookmark = bookmark;
               }
               return selectedBookmark;
           }

           public static class ContactFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
               MainActivity anActivity;
               private TextView viewOneTv;
               private ImageView copyImage;
               ...
               View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
                   ...
                   View view = inflater.inflate(R.layout.contact_us, viewGroup, false);
                   anActivity = (MainActivity) getActivity();
                   assert anActivity != null;
                   Typeface titleFont = Typeface.
                           createFromAsset(anActivity.getAssets(), "fonts/Lobster_1.3.otf");
                   TextView titleTextTwo = view.findViewById(R.id.textviewtitle2);
                   titleTextTwo.setTypeface(titleFont);
                   copyImage = view.findViewById(R.id.copy_icon2);
                   viewOneTv = view.findViewById(R.id.textviewtitle3);
                   Glide.with(anActivity).load("https://s3.amazonaws.com/istandwithrefugees-userfiles-mobilehub-1734667399/public/copy.png")
                           .into(copyImage);
                   copyImage.setOnClickListener(new View.OnClickListener() {
                       @Override
                       public void onClick(View v) {
                           ClipboardManager clipboard = (ClipboardManager) anActivity.getSystemService(Context.CLIPBOARD_SERVICE);
                           ClipData clip = ClipData.newPlainText("Copied address", viewOneTv.getText().toString());
                           clipboard.setPrimaryClip(clip);
                       }
                   });
                   anActivity.getmTitle().setText("Contact Us");
                   anActivity.getSupportActionBar().show();
                   return view;
               }
