 ...
 */
class CustomDialogNoSearchWithButton extends Dialog {


    public CustomDialogNoSearchWithButton(Activity a) {
        super(a);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_dialog_no_search_with_buttons);
